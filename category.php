...
<?php if ( have_posts() ): ?>
	<h1>
		<?php echo __('Category Archive:', 'wp_denysmyr'); ?> <?php echo single_cat_title( '', false ); ?>
	</h1>
...
<?php else: ?>
	<h1>
		<?php echo __('No posts to display in', 'wp_denysmyr'); ?> <?php echo single_cat_title( '', false ); ?>
	</h1>
<?php endif; ?>
