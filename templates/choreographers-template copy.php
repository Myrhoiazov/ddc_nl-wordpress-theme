                    ...
                    <?php if ( $the_query->have_posts() ) : ?>
                        <div class="row choreographer-row mt-5">
                            ...
                            while ( $the_query->have_posts() ) :
                                ...
                                ?>
                                <a href="<?php the_permalink(); ?>" class="col-6 col-lg-3 choreographer <?php echo strtolower(preg_replace('/[^a-z]/i', '-', $country)); ?>" style="opacity: 1;">
