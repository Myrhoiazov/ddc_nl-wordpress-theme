    ...
    <div class="video-wrap">
        ...
        <div class="video">
            <video muted autoplay loop playsinline width="250">
                <source src="<?php echo get_template_directory_uri() ?>/videos/D2_RECAP.webm" type="video/webm" />
            </video>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <?php $BsWp->get_template_parts(['parts/home/choreographers'], ['edition' => 'third']) ?>
            </div>
        </div>
    </div>
</section>
<section id="highlights">
    <span class="small-logo">
        <span class="year white">2025</span>
        <img loading="lazy" decoding="async" src="<?php echo get_template_directory_uri() ?>/images/ddc_logo_white.png" alt="">
        <div class="place">
            Amsterdam
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <?php  $BsWp->get_template_parts(['parts/home/highlights'], ['edition' => 'third']) ?>
            </div>
        </div>
    </div>
</section>
<section id="competition" class="d-none">
    <span class="small-logo">
        <span class="year">2025</span>
        <img loading="lazy" decoding="async" src="<?php echo get_template_directory_uri() ?>/images/ddc_logo_white.png" alt="">
        <div class="place">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <?php $BsWp->get_template_parts(['parts/home/team'], ['edition' => 'third']) ?>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <?php $BsWp->get_template_parts(['parts/home/support-team'], ['edition' => 'third']) ?>
            </div>
        </div>
    </div>
</section>
<section id="special_thanks" class="d-none">
    <span class="small-logo">
