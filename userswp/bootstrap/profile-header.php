...
<div class="card shadow-0 border-0 mw-100"><?php }
    ...
    <div class="card-body  <?php if ( ! $uwp_in_user_loop ) { ?>mt-xl-0 px-0 pb-0 pt-0<?php } else { ?>text-center pb-0<?php } ?>">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 <?php if ( ! $uwp_in_user_loop ) {
                ...
                <ul class="list-group border-0 m-0 p-0 bg-transparent">
					...
					<?php if(key_exists('administrator', $user->caps) || $user->roles[0] == 'heelsmaster'): ?>
						<li class="list-group-item border-0 mt-3 p-0 bg-transparent uwp-profile-badge">
							<?php if(key_exists('administrator', $user->caps)): ?>
								<div class="badge badge-dark">
									Organization
								</div>
							<?php elseif($user->roles[0] == 'heelsmaster') : ?>
                ...
                <div class="col-12">
					<h2 class="mt-4">
						<?php if ( !$uwp_in_user_loop ) {
							...
							echo  esc_attr( $user->display_name . ' | ' . $firstName . ' ' . $lastName ) ;
						} ?>
					</h2>
					<?php 
